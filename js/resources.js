// NMGC — Resources page
// Fetches minutes.json from S3 and renders the Meeting Minutes Archive.

(function () {
  var MINUTES_URL = 'https://nmgc-pdfs.s3.us-east-2.amazonaws.com/minutes.json?v=' + Date.now();
